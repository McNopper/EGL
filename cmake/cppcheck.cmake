...
#
# Note on --std: with --project=compile_commands.json cppcheck takes the
# language and -std per translation unit from the compilation database, so the
# C entry point (src/egl.c) is analysed as C and the rest as C++17. The value
# below is the fallback for files outside the database.
# ============================================================
...
# third-party sources), the output archive dir and the vcpkg tree.
set(CPPCHECK_EXCLUDES
    -i${CMAKE_BINARY_DIR}
    -i${CMAKE_SOURCE_DIR}/build
    -i${CMAKE_SOURCE_DIR}/lib
    -i${CMAKE_SOURCE_DIR}/vcpkg
)

# Default profile: high signal-to-noise. Fails the target on real findings.
# unusedFunction is suppressed in cppcheck.supp because EGL is a library -
# the exported egl* API has no caller inside this repository.
